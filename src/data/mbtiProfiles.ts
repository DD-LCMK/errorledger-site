// StreamArcade Deep Scientific MBTI 16-Type Exhaustive Profiles
// Pure Jungian cognitive function hierarchies, strengths, blind spots, stress loop dynamics, career blueprints, love compatibility, and streamer personas.
...
export const MBTI_PROFILES: Record<string, MbtiProfile> = {
  ...
  "INTP": {
    ...
    "relationship": {
      ...
      "challengingMatchReasonKo": "사회적 의전이나 감정적 공감을 최우선으로 요구하는 유형과는 대화 방식의 차이로 인해 오해가 생길 수 있어 상호 존중과 명확한 의사소통이 중요합니다.",
      "challengingMatchReasonEn": "Differing priorities between impersonal logic and emotional/social harmony require deliberate patience and empathetic adaptation."
    },
    "streamerStyle": {
  ...
  "INFJ": {
    ...
    "relationship": {
      ...
      "challengingMatchReasonKo": "매우 현실적이고 직설적인 감각/행동 중심 유형과는 이상주의적 가치관과 내면의 깊은 상징을 공유하기까지 시간과 배려가 필요합니다.",
      "challengingMatchReasonEn": "Grounded, direct sensory pragmatists may struggle with INFJ’s mystical abstraction unless both partners intentionally build a shared bridge."
    },
    "streamerStyle": {
  ...
  "INFP": {
    ...
    "relationship": {
      ...
      "challengingMatchReasonKo": "엄격한 효율성과 규칙을 강조하는 유형 앞에서는 INFP의 여린 감수성이 상처받기 쉬우므로, 감정을 비난하지 않고 존중해 주는 태도가 필수적입니다.",
      "challengingMatchReasonEn": "Rigid demands for procedural efficiency can inadvertently crush INFP’s sensitive idealism; mutual gentleness and emotional safety are crucial."
    },
    "streamerStyle": {
  ...
  "ENFJ": {
    ...
    "relationship": {
      ...
      "challengingMatchReasonKo": "지나치게 차갑거나 감정을 표현하지 않는 논리 중심 유형 앞에서는 정서적 교감이 차단되어 외로움을 느낄 수 있습니다.",
      "challengingMatchReasonEn": "Detached logic and emotional reservation can leave ENFJ feeling unappreciated and starved of genuine affection."
    },
    "streamerStyle": {
  ...
  "ENFP": {
    ...
    "relationship": {
      ...
      "challengingMatchReasonKo": "원칙과 정해진 루틴을 철저히 지키려는 보수적 성향과 자유분방한 모험심이 충돌할 수 있어, 서로의 생활 방식을 존중하는 유연함이 필요합니다.",
      "challengingMatchReasonEn": "Rigid routines and procedural enforcement stifle ENFP’s creative spontaneity unless grounded in deep mutual tolerance."
    },
    "streamerStyle": {
  ...
  "ISTJ": {
    ...
    "relationship": {
      ...
      "challengingMatchReasonKo": "예측 불가능하게 계획을 바꾸고 규칙을 깨려는 즉흥적 유형과는 마찰이 생길 수 있으므로, 명확한 기준과 상호 배려가 필요합니다.",
      "challengingMatchReasonEn": "Unpredictable pivots and casual disregard for rules test ISTJ’s structured patience, requiring clear agreements and mutual respect."
    },
    "streamerStyle": {
  ...
  "ISFJ": {
    ...
    "relationship": {
      ...
      "challengingMatchReasonKo": "논쟁을 즐기고 비판을 서슴지 않는 직설적인 유형 앞에서는 깊은 마음의 상처를 받을 수 있어 따뜻하고 부드러운 화법이 요구됩니다.",
      "challengingMatchReasonEn": "Aggressive debates and blunt criticisms can deeply wound ISFJ’s harmonious nature, requiring tender empathy and gentle reassurance."
    },
    "streamerStyle": {
  ...
  "ESTJ": {
    ...
    "relationship": {
      ...
      "challengingMatchReasonKo": "감수성이 풍부하고 규칙에 얽매이기 싫어하는 자유로운 영혼에게 명령조로 지시할 경우 심각한 반발을 부를 수 있습니다.",
      "challengingMatchReasonEn": "Demanding compliance and imposing strict rules can alienate gentle feeling types, requiring softer patience and empathetic listening."
    },
    "streamerStyle": {
  ...
  "ESFJ": {
    ...
    "relationship": {
      ...
      "challengingMatchReasonKo": "사회적 배려나 리액션이 부족하고 혼자만의 세계에 갇힌 성향을 마주하면 무시당했다고 오해하기 쉽습니다.",
      "challengingMatchReasonEn": "Emotional aloofness and a lack of overt social validation can make ESFJ feel unvalued, requiring explicit verbal appreciation."
    },
    "streamerStyle": {
  ...
  "ISTP": {
    ...
    "relationship": {
      ...
      "challengingMatchReasonKo": "지나친 감정적 간섭이나 잦은 연락, 통제를 시도하는 관계에서는 숨이 막혀 관계를 끊어버릴 위험이 있습니다.",
      "challengingMatchReasonEn": "Emotional demands, constant check-ins, or perceived micromanagement provoke ISTP to withdraw defensively."
    },
    "streamerStyle": {
      ...
      "recommendedContent": [
        "하드코어 FPS (발로란트, 에이펙스 레전드)",
        "소울라이크 노히트 클리어 챌린지",
        "기계 분해/수리 및 커스텀 PC 빌드"
      ]
    },
  ...
  "ISFP": {
    ...
    "relationship": {
      ...
      "challengingMatchReasonKo": "권위적이고 비판적인 태도로 개인의 감정과 개성을 억누르려 할 때 심한 상처와 방어기제를 형성하게 됩니다.",
      "challengingMatchReasonEn": "Authoritarian mandates and blunt critiques trigger deep emotional retreats in ISFP; soft, gentle patience is essential."
    },
    "streamerStyle": {
  ...
  "ESTP": {
    ...
    "relationship": {
      ...
      "challengingMatchReasonKo": "추상적이고 복잡한 감정의 심연을 요구하거나 말 한마디에 깊이 상처받는 내면 세계를 이해하는 데 인내심이 필요합니다.",
      "challengingMatchReasonEn": "Deep, introverted emotional processing and abstract metaphors feel frustratingly slow to ESTP without deliberate patience."
    },
    "streamerStyle": {
  ...
  "ESFP": {
    ...
    "relationship": {
      ...
      "challengingMatchReasonKo": "지나치게 진지하고 모든 것을 분석하려 드는 태도 앞에서는 분위기가 가라앉고 답답함을 느낄 수 있습니다.",
      "challengingMatchReasonEn": "Cold analytical critiques and theoretical pedantry kill the vibrant spontaneity that fuels ESFP’s joyful existence."
    },
    "streamerStyle": {
