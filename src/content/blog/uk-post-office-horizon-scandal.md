...
: Analytical reconstruction: The documented behaviour is consistent with failures of transaction idempotency, state management and reconciliation. The evidence does not by itself establish the exact internal implementation mechanism responsible for each defect.
