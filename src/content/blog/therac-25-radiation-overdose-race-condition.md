...
keywords:
  - "Therac-25 radiation overdose cause"
  - "Therac-25 race condition bug explained"
  - "medical linear accelerator software failure deaths"
  - "Class3 counter overflow Therac bug"
  - "AECL radiation accident software defect"
  - "safety critical software failure history"
  - "Leveson Turner Therac-25 investigation"
  - "hardware interlock removal caused deaths"
faqItems:
  - q: "What caused the Therac-25 radiation overdoses?"
    a: "Two distinct software defects were reconstructed by Leveson and Turner. The Tyler defect was a race condition between the data-entry task and the beam-setup task that allowed the operator to change treatment mode after the machine had already begun configuring itself, producing a physically dangerous state. The Yakima defect involved an 8-bit counter (Class3) that rolled over to zero, causing the software to skip a collimator safety check. Both defects were enabled by the architectural decision to remove independent hardware interlocks."
  - q: "How many people were killed or injured by the Therac-25?"
    a: "There were six known radiation overdose accidents between June 1985 and January 1987. Three patients subsequently died. Causation in the fatalities was complex: some patients were already suffering from terminal cancer and the radiation injuries contributed to or accelerated their deaths. Three further patients survived with severe radiation burns and injuries."
  - q: "What was the Therac-25 race condition (Tyler defect)?"
    a: "The Tyler race condition occurred because the data-entry task and the magnet-setup task ran concurrently and mutated shared state variables without adequate isolation. When an experienced operator edited the treatment prescription quickly after the machine had already begun setting up based on the first entry, the machine could enter a state where its physical configuration did not match the intended mode — enabling the beam without the required beam-scattering X-ray target in place."
  - q: "Why did the Therac-25 have no hardware safety interlocks?"
    a: "The Therac-25 was designed to rely on software for safety enforcement as a cost and simplicity trade-off. Physical hardware interlocks present in predecessor machines (Therac-6 and Therac-20) were removed or not duplicated in the Therac-25. The formal hazard analysis treated the software as infallible, meaning no independent hardware layer existed to prevent beam delivery when the software entered a corrupted state."
  - q: "What did the Malfunction 54 error code mean?"
    a: "Malfunction 54 was a cryptic error code that appeared during the Tyler accidents. It indicated a 'dose input 2' error, which the machine interpreted as an underdose. In reality, the ion chambers had saturated from a massive radiation overdose. The misleading message caused operators to press 'Proceed' to try again, resulting in repeated overdose exposures before the session was terminated."
  - q: "What FDA action followed the Therac-25 accidents?"
    a: "The FDA declared the Therac-25 defective and mandated a comprehensive Corrective Action Plan (CAP) requiring AECL to redesign the software, improve error message clarity, restrict mid-setup prescription editing, and critically — install independent physical hardware interlocks to monitor the treatment turntable and prevent beam delivery if the physical state was misaligned."
  - q: "Why didn't testing catch the Therac-25 bugs?"
    a: "Testing was primarily conducted on integrated systems rather than through adversarial concurrent timing analysis. Testers did not type as fast as experienced hospital operators, so the precise timing windows required to trigger the race condition were rarely encountered in the lab. The formal safety analysis also assumed the software would not fail, leaving no structured effort to find conditions under which it would."
